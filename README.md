...
断断续续每天抽出下午的时间差不多用了3个月看完了这本书，期间也顺带学习了makefile、gcc、valgrind等工具（之前的学习总是局限在Windows的Visual Studio，而且学习也总是沉迷于语法本身），可以说这本书让我成长了不少，当然自己也还需要走很长的路。
